...
def train(model, collate_fn):
    os.environ["WANDB_PROJECT"] = "language-distance-paligemma-no-landmarks" 
    os.environ["WANDB_LOG_MODEL"] = "checkpoint"             

    train_dataset = LanguageDistanceDataset(annotations_folder="/home/alekseyvalouev/goalnav/language-annotations-train", lang_labels=False)
    val_dataset = LanguageDistanceDataset(annotations_folder="/home/alekseyvalouev/goalnav/language-annotations-test", lang_labels=False)

    args = TrainingArguments(
        output_dir="language-distance-paligemma-no-landmarks",
