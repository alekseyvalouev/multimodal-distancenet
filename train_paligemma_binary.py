...
def train(model, collate_fn):
    os.environ["WANDB_PROJECT"] = "binary-reachability-paligemma" 
    os.environ["WANDB_LOG_MODEL"] = "checkpoint"             

    train_dataset = BinaryReachabilityDataset(annotations_folder="/home/alekseyvalouev/goalnav/language-annotations-train")
    val_dataset = BinaryReachabilityDataset(annotations_folder="/home/alekseyvalouev/goalnav/language-annotations-test")

    args = TrainingArguments(
        output_dir="binary-reachability-paligemma",
